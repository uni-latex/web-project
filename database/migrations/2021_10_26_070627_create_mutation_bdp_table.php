...
class CreateMutationBdpTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        /** transfer data
        insert into `web-latexindo`.mutation_bdp (id, goods_code, goods_name, unit, beginning_balance, entering, spending, compliance, final_balance, stock_opname, difference, annotation, mutation_date) select id, goods_code, goods_name, unit, beginning_balance, entering, spending, compliance, final_balance, stock_opname, difference, annotation, mutation_date from MutasiBDP
         */

        Schema::create('mutation_bdp', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('mutation_bdp');
    }
}
