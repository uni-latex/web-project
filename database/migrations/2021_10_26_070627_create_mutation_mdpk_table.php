...
class CreateMutationMdpkTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        /** transfer data
        insert into `web-latexindo`.mutation_mdpk (id, goods_code, goods_name, unit, beginning_balance, entering, spending, compliance, final_balance, stock_opname, difference, annotation, mutation_date) select id, goods_code, goods_name, unit, beginning_balance, entering, spending, compliance, final_balance, stock_opname, difference, annotation, mutation_date from MutasiMdPK
         */

        Schema::create('mutation_mdpk', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('mutation_mdpk');
    }
}
