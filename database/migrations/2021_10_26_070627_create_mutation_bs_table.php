...
class CreateMutationBsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        /** transfer data
        insert into `web-latexindo`.mutation_bs (id, goods_code, goods_name, unit, beginning_balance, entering, spending, compliance, final_balance, stock_opname, difference, annotation, mutation_date) select id, goods_code, goods_name, unit, beginning_balance, entering, spending, compliance, final_balance, stock_opname, difference, annotation, mutation_date from MutasiBS
         */

        Schema::create('mutation_bs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('mutation_bs');
    }
}
